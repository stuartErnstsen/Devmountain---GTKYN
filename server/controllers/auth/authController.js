...
module.exports = {
    login: async (req, res) => {
        ...
        const [userFound] = await db.auth.find_user_with_auth({ usernameOrEmailInput })
    ...
    register: async (req, res) => {
        ...
        const [userNameAlreadyExists] = await db.auth.find_user_by_username({ usernameInput })
        const [emailAlreadyExists] = await db.auth.find_user_by_email({ emailInput })
